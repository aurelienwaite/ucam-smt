...
public enum Feature {
	...
	SOURCE_2_TARGET_LEXICAL_PROBABILITY(Scope.GLOBAL, ComputeLocation.LEXICAL_SERVER),
	TARGET_2_SOURCE_LEXICAL_PROBABILITY(Scope.GLOBAL, ComputeLocation.LEXICAL_SERVER),
	PROVENANCE_SOURCE_2_TARGET_LEXICAL_PROBABILITY(Scope.PROVENANCE, ComputeLocation.LEXICAL_SERVER),
	PROVENANCE_TARGET_2_SOURCE_LEXICAL_PROBABILITY(Scope.PROVENANCE, ComputeLocation.LEXICAL_SERVER),
