...
/**
 * Feature that computes the number of target elements in a rule, i.e. the
 * number of target terminals and nonterminals in a rule.
 * 
 * @author Juan Pino
 * @date 14 July 2014
 */
public class NumberTargetElements implements Feature {

	private final static String featureName = "number_target_elements";
	...
	public Map<Integer, Double> value(Rule r, FeatureMap mapReduceFeatures,
		...
		res.put(featureIndex, (double) r.getTarget().size());
		return res;
	}
